...
ALLOWED_HOSTS = ['https://studentia.onrender.com']
...
# Configuración básica de archivos estáticos (siempre presente)
STATIC_URL = '/static/'
...
# Configuración de archivos de medios (siempre presente)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
